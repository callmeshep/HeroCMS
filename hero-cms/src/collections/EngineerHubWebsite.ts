      ...
      tabs: [
        ...
        // THE APP
        {
          ...
          fields: [
            ...
            {
              name: 'wishlistTone',
              label: 'Wishlist Card — Card Colour',
              type: 'select',
            ...
            {
              name: 'updateLogTone',
              label: 'Update Log Card — Card Colour',
              type: 'select',
              options: ['Peach', 'Pink', 'Blue', 'Lavender', 'Mint', 'Yellow', 'White'],
            ...
            {
              name: 'appDownloadHeadline',
              label: 'Download App Card — Headline',
              type: 'text',
              defaultValue: 'Get the app',
            },
            {
              name: 'appDownloadBodyText',
              label: 'Download App Card — Body Text',
              type: 'textarea',
            },
            { name: 'appStoreUrl', label: 'Download App Card — Apple App Store URL', type: 'text' },
            { name: 'googlePlayUrl', label: 'Download App Card — Google Play URL', type: 'text' },
            {
              name: 'appDownloadTone',
              label: 'Download App Card — Card Colour',
              type: 'select',
              options: ['Peach', 'Pink', 'Blue', 'Lavender', 'Mint', 'Yellow', 'White'],
              defaultValue: 'Mint',
            },
        ...
        // FORMS & SURVEYS
        {
          ...
          fields: [
            ...
            {
              name: 'reportProblemTone',
              label: 'Report a Problem — Card Colour',
              type: 'select',
              options: ['Peach', 'Pink', 'Blue', 'Lavender', 'Mint', 'Yellow', 'White'],
              defaultValue: 'Yellow',
            },
            ...
            {
              name: 'insuranceTone',
              label: 'Insurance & Docs — Card Colour',
              type: 'select',
              options: ['Peach', 'Pink', 'Blue', 'Lavender', 'Mint', 'Yellow', 'White'],
              defaultValue: 'Blue',
            },
        ...
        // MEMBERSHIP
        {
          ...
          fields: [
            ...
            {
              name: 'membershipTiersTone',
              label: 'Membership Tiers Card — Card Colour',
              type: 'select',
              options: ['Peach', 'Pink', 'Blue', 'Lavender', 'Mint', 'Yellow', 'White'],
              defaultValue: 'Lavender',
            },
        ...
        // CONTACT
        {
          ...
          fields: [
            ...
            {
              name: 'messageCardTone',
              label: '"Leave a message" Card — Card Colour',
              type: 'select',
              options: ['Peach', 'Pink', 'Blue', 'Lavender', 'Mint', 'Yellow', 'White'],
              defaultValue: 'Mint',
            },
