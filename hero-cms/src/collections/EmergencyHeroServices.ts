...
export const EmergencyHeroServices: CollectionConfig = {
  ...
  fields: [
    ...
    { name: 'categoryLabel', label: 'Category Label (e.g. Plumber)', type: 'text' },
    {
      ...
      label: 'Service Page — Background Image (Desktop)',
      type: 'upload',
      relationTo: 'media',
    },
    {
      name: 'heroBackgroundImageMobile',
      label: 'Service Page — Background Image (Mobile)',
      type: 'upload',
      relationTo: 'media',
    },
    {
      name: 'thankYouBackgroundImageDesktop',
      label: 'Thank You Page — Background Image (Desktop)',
      type: 'upload',
      relationTo: 'media',
    },
    {
      name: 'thankYouBackgroundImageMobile',
      label: 'Thank You Page — Background Image (Mobile)',
      type: 'upload',
      relationTo: 'media',
    },
